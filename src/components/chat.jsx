...
import chatLogo from '../img/bg/chat-logo.webp'
                ...
                <>
                    <div className={"w-full h-full pt-10 overflow-y-auto"} >
                        ...
                        {state.messages.map((message, index) => (
                            <div key={index} className={message.sent_by === username ? "flex flex-col items-end p-5 w-full" : "flex flex-col p-5 w-full"}>
